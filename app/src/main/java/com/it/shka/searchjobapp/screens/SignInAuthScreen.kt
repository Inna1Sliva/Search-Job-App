...
import com.it.shka.searchjobapp.UserAuthViewModel

@Composable
fun SignInAuthScreen(navController: NavController, authViewModel: UserAuthViewModel) {
            ...
            Column (modifier = Modifier
                ...
                Row(modifier = Modifier
                    ...
                    Button(modifier = Modifier
                        ...
                        onClick = {
                                authViewModel.isValidEmailUser(email.toString(), context)
                        },
