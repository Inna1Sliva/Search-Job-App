...
fun DialogScreen (){
    Box(modifier = Modifier
        .fillMaxSize()
        .background(color = colorResource(R.color.dialog_bag)),
        ...
        Column(
            modifier = Modifier
               // .padding(16.dp)
                .fillMaxWidth()
                .background(color = Color.Black, shape = RoundedCornerShape(topStart = 8.dp, topEnd = 8.dp))
            ...
            Spacer(modifier = Modifier
                ...
                .background(color = colorResource(R.color.Basic_Grey_2), shape = RoundedCornerShape(10.dp)))
            Row (
                modifier = Modifier
                    .padding(16.dp)
                .fillMaxWidth()
